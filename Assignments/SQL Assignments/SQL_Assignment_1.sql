...
insert into project1 (project_id, descr, start_date, planned_end_date, actual_end_date, budget,clientID)
...
insert into empprojecttaskss (Project_ID,empno,start_date,end_date,task,status)
values 
